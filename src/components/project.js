            ...
            return (
                <div className="projects-grid"  >
                    <Card shadow={5} style={{width: '100%'}}>
                        <Tappable onTap={this.handleShowDialogNTT} style={{ cursor: 'pointer' }}><CardTitle className="mdl-card__title_ntt" style={{  height: '436px', cursor: 'pointer' }}><h4 className="author" style={{ color: '#da7c18', fontFamily: 'Roboto Mono,monospace' }}>By Lacey Yahnke</h4></CardTitle></Tappable>
