...
<Layout>
    <Header color="white" className="header-color" title={<Link style={{textDecoration: 'none', color:'white', fontFamily: 'Roboto Mono,monospace'}} to="/">Nicola Montaleone</Link>} sroll>
        <Navigation>
